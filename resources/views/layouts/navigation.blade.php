<nav x-data="{ open: false }" class="bg-gray-800 sticky top-0 z-50 backdrop-blur-md transition duration-300">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-16">
      <div class="flex">
        ...
        <!-- Navigation Links -->
        <div class="hidden text-sm tracking-tight space-x-8 sm:-my-px sm:ms-10 sm:flex" style="font-family: 'Press Start 2P', monospace;">
        ...
        <x-dropdown align="right" width="48">
          <x-slot name="trigger">
            <div class="flex items-center px-5 cursor-pointer">
              ...
              <button
                class="inline-flex tracking-tight text-sm items-center px-2 py-2 border border-transparent leading-4 font-medium rounded-md text-white hover:text-gray-200 focus:outline-hidden transition ease-in-out duration-150 cursor-pointer" style="font-family:'Press Start 2P', sans-serif;">
