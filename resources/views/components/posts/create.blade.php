...
<div
  class="relative max-w-4xl p-4 bg-gray-900 rounded-md border-4 border-yellow-400 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] sm:p-5">
  <!-- Modal header -->
  <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
    <h3 class="text-lg font-semibold text-white">Add Post</h3>
  </div>
  ...
  <form action="/dashboard" method="POST" id="post-form">
    ...
    <div class="mb-3">
      ...
      <select name="category_id" id="category"
        class="@error('category_id')
        bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
        @enderror border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
    ...
    <div class="mb-4">
      ...
      <textarea id="body" name="body" rows="4"
        ...
        bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
        @enderror block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500"
